...
import { UserType, SignupState, STATE } from "../../model/interfaces";
...
const UserDetails: React.FC<UserDetailsProps> = (props) => {
  ...
  const [values, setValues] = useState<UserType>(userDetails);

  const roleLabel = props?.role === "farmer" ? "Farmer" : "Pilot";
